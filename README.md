...
Следующий этап - это создание нескольких версий одной и той же фичи (в данном случае это экспорт данных) с целью сравнения результата и дальнейшего выбора элементов функционала, которые попадут в рабочую версию проекта

## Первый использованный промт
